...
const initialPosts = [
  ...
  },
  {
    ...
    content: "🧘‍♀️ 早安！今天跟大家分享一套清晨瑜伽序列，帮助唤醒身体，激活能量：\n\n1. 太阳礼拜 × 3组\n2. 猫牛式 × 10次\n3. 下犬式 保持1分钟\n4. 战士一式 两侧各保持30秒\n\n记得要缓慢进入体式，感受呼吸和身体的连接～",
    images: [
  ...
  },
  {
    ...
    content: "🎾 网球肘困扰着很多办公室职员，今天教大家几个缓解动作：\n\n1. 手腕背伸拉伸\n2. 前臂按摩\n3. 冰敷热敷交替\n4. 等长收缩练习\n\n如果持续疼痛，建议及时就医！",
    images: [
